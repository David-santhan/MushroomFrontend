...
function Home() {
    ...
    const handleImageUploadToServer = async () => {
        ...
        try {
            const response = await axios.post('https://mushroombackend.onrender.com/api/upload', formData, {
                headers: {
    ...
    const handleAddMushroom = async () => {
        ...
        try {
            const response = await axios.post('https://mushroombackend.onrender.com/api/addMushroom', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
